<template>
  <section>
    ...
    <el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
      <el-form :inline="true" :model="stu" align="left" >
        <el-form-item>
          <el-button type="primary" icon="el-icon-edit" v-on:click="jmp2create">新增</el-button>
        </el-form-item>
        <el-form-item>
          <el-button type="primary" icon="el-icon-top" v-on:click="export2Excel">信息导出</el-button>
        </el-form-item>
      </el-form>
    </el-col>
    <!--列表-->
      ...
      bli() {
        ...
        if(!this.$store.state.schooltables[i].target_show_type) //检查下标为i的schooltable[i]是否为空
        {
          ...
          for (var j = 0; j < shuzu.length ; j++)
          {
            ...
            if (this.$store.state.schooltables[c-1].target_show_type == 'text')
            {
              var des = {description:'null',age:'null'};
              this.targetIni[this.$store.state.schooltables[c-1].target_description]= des;
              this.allTargetIni[this.$store.state.schooltables[c-1].target_description]=des;
            }
            else
            {
              this.data1 = c-1;
