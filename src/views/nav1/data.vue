      ...
      <div class="block">
        ...
        <div class="add">
          <el-form v-model="newChild">
            ...
            <el-form-item>
              <el-button type="primary" @click="editSchoolData" class="textButton" v-if="schoolExisted===true">修改
              </el-button>
              <el-button type="primary" @click="createSchoolData" class="textButton" v-if="schoolExisted===false">新建
              </el-button>
