      ...
      <el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
        <el-form :inline="true"  align="left" >
          <el-form-item label="课程">
            <el-input align="left" :disabled="disabled" v-model="course"></el-input>
          </el-form-item>
          ...
          <el-form-item label="月份">
            <el-select v-model="month" placeholder="请选择月份" :disabled="disabled">
              <el-option
            ...
            <el-table
              ...
              <el-table-column
                ...
                <template slot="header">
                  <el-button type="primary" @click="addTeachingAim()">添加</el-button>
                </template>
